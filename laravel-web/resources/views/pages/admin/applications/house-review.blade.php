...
@section('title', 'Perbaikan Status Rumah | KIP-K UNAIR')
@section('description', 'Halaman admin untuk melengkapi status rumah pada data mentah applicant offline')
        ...
        <section class="mb-8 grid grid-cols-1 gap-6 xl:grid-cols-12">
            <div class="relative overflow-hidden rounded-3xl bg-primary px-8 py-10 text-white shadow-2xl xl:col-span-7 xl:px-10">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="max-w-3xl text-4xl font-black leading-tight tracking-tight">Lengkapi status rumah applicant offline sebelum data dipakai ke tahap encoding dan model.</h1>
                    <p class="mt-5 max-w-2xl text-sm font-medium leading-7 text-blue-100/90">
                        Halaman ini khusus untuk merapikan kolom <strong>status rumah</strong> pada data mentah impor.
        ...
        <section class="overflow-hidden rounded-3xl bg-white shadow-lg">
            <div class="flex flex-col gap-4 border-b border-slate-100 px-6 py-6 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <h2 class="mt-1 text-2xl font-extrabold tracking-tight text-on-surface">Kelola status rumah applicant</h2>
                    <p class="mt-2 max-w-2xl text-sm font-medium text-on-surface-variant">Secara default tabel ini fokus ke baris yang masih kosong. Gunakan dokumen pendukung untuk memilih nilai yang paling sesuai.</p>
                </div>
